...
find Final_Project_in_Processing-restructured/structured -type f -name "*.pde" -exec ln -s {} Final_Project_in_Processing-restructured/globed/netHead/ \; && echo Linked
...
lndir Final_Project_in_Processing-restructured/structured/data/ Final_Project_in_Processing-restructured/globed/netHead/data/ && echo Data Dir Linked
